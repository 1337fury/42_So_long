...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   map_checker_bonus_utils.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: abdeel-o < abdeel-o@student.1337.ma>       +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/04 12:02:51 by abdeel-o          #+#    #+#             */
/*   Updated: 2023/02/05 20:24:51 by abdeel-o         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_limits(char **map)
{
	...
	if (element.exit == 1 && element.collectible >= 1 \
		&& element.player == 1 && element.enemies == 1)
		return (1);
	return (0);
}
